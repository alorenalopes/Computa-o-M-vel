...
class GraficoActivity : Activity(), View.OnClickListener {

    private val TAG = "GraficoActivity"
    ...
    private fun grafico() {
        ...
        firestoreListener = firestoreDB!!.collection("historico")
            .addSnapshotListener(EventListener { documentSnapshots, e ->
                ...
                despesa.add(SliceValue(valoralimentacao.toFloat(), this.getColor(R.color.red)).setLabel("Alimentação " + valoralimentacao))
                despesa.add(SliceValue(valorcartao.toFloat(), this.getColor(R.color.red)).setLabel("Cartão " +valorcartao))
                despesa.add(SliceValue(valorlazer.toFloat(), this.getColor(R.color.red)).setLabel("Lazer " +valorlazer))
                despesa.add(SliceValue(valormoradia.toFloat(), this.getColor(R.color.red)).setLabel("Moradia " + valormoradia))
                despesa.add(SliceValue(valorsaude.toFloat(), this.getColor(R.color.red)).setLabel("Saúde " +valorsaude ))
                despesa.add(SliceValue(valoroutrosD.toFloat(), this.getColor(R.color.red)).setLabel("Outros " +valoroutrosD))
                receita.add(SliceValue(valorsalario.toFloat(), this.getColor(R.color.green)).setLabel("Salário " +valorsalario))
                receita.add(SliceValue(valorpremio.toFloat(), this.getColor(R.color.green)).setLabel("Prêmio " +valorpremio))
                receita.add(SliceValue(valorpresente.toFloat(), this.getColor(R.color.green)).setLabel("Presente " +valorpresente))
                receita.add(SliceValue(valoroutrosR.toFloat(), this.getColor(R.color.green)).setLabel("Outros " +valoroutrosR))
